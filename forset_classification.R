...
#calcolo le coordinate per ogni punto sul dataset bilanciato rispetto alle wildness area:wild_b
#tolgo la variabile cases da wild_b
wild_b<- wild_b[, -13]

#coordinate di orgni wild area
#1 Rawah Wilderness -106.00258529 40.87431477000001
#2 neota 40.5232284°N, -105.839868°W
#3 Comanche Peak -105.70597307 40.68814297
#4 cache la poudre -105.4417727 40.69197401000002
